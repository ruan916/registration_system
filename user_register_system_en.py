...
class admin_window:
    ...
    def search_record(self):
        try:
            ...
            raise messagebox.showerror("ERROR","IT WAS NOT POSSIBLE FIND THIS DATA")

    def reset_db(self):
        yesno=messagebox.askquestion("REDEFINE DATABASE","ALL DATA IN DATABASE WILL BE LOST, CONTINUE?")
        if(yesno=='yes'):
            self.theCursor.execute("DROP TABLE users")
            messagebox.showinfo("DATABASE REDEFINED","DATABASE REDEFINED")
            self.setup_db()
            self.update_tree()
    ...
    def __init__(self):
        ...
        self.username_lbl = Label(self.admin_window,text="USER: ",font="Helvetica, 16",bg='light green',fg='#001a00')
        ...
        Label(self.admin_window,text="SEARCH FOR THE NAME: ",font="Helvetica, 16",bg='light green',fg='#001a00').grid(row=5,column=0,columnspan=2,pady=5,sticky=E)
        ...
        self.bt_adm_reset = Button(self.admin_window,text="REDEFINE DATABASE",font="Helvetica, 16",command=self.reset_db)
...
class register_window:
    ...
    def new_user(self):
        try:
            if(self.username_text.get()!="" and self.password_text.get()!=""):
                ...
                messagebox.showinfo("SUCCESS","REGISTERED WITH SUCCESS!\nNOW, MAKE YOUR LOGIN")
            else:
                messagebox.showwarning("WARNING","PLEASE, FILL ALL OF FIELDS")
        except sqlite3.IntegrityError:
            messagebox.showerror("ERROR","THIS USER HAS BEEN REGISTERED IN DATABASE")
        except:
    ...
    def __init__(self):
        ...
        Label(self.register_window,text="USER: ",font="Helvetica, 16",bg='light green',fg='#001a00').grid(row=1,column=0,sticky=E)
...
class login_window:
    ...
    def __init__(self):
        ...
        Label(self.login_window,text="USER: ",font="Helvetica, 16",bg='light green',fg='#001a00').grid(row=1,column=0,sticky=E)
...
class main_window:
    def login(self):
        try:
            ...
            raise Exception("The login window cannot running")
